...
/bin/bash /usr/share/centreon/bin/writeEngineSecrets.sh "${PARSED_URL[SCHEME]}://${PARSED_URL[HOST]}:${PARSED_URL[PORT]}/$CENTREON_BASE_URI" "$API_USERNAME" "$API_TARGET_PASSWORD"
exit 0
