...
return RectorConfig::configure()
    ->withBootstrapFiles([
        __DIR__ . '/../tools/rector/config/rector.bootstrap.php',
    ])
    ->withPaths([
        __DIR__ . '/api',
        __DIR__ . '/config',
...
//        __DIR__ . '/../centreon-open-tickets/.php-cs-fixer.legacy.src.php',
    ...
    ->withSkip([
        __DIR__ . '/www/class/centreon-clapi/centreonDependency.class.php',
        __DIR__ . '/www/class/centreon-clapi/centreonContact.class.php',
    ])
    ->withRules(
        [
            // ******************* performance (done) *******************
...
//            SensitiveHereNowDocRector::class,
            // Changes heredoc/nowdoc that contains closing word to safe wrapper name (7.3)
//            SensitiveConstantNameRector::class,
            // Changes case insensitive constants to sensitive ones.(7.3)
