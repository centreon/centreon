...
declare -A SUPPORTED_VERSION=([21.10]=1 [22.04]=1 [22.10]=1 [23.04]=1 [23.10]=1 [24.04]=1 [24.07]=1 [24.09]=1 [24.10]=1 [24.11]=1)
...
version=${ENV_CENTREON_VERSION:-"24.11"}        #Default version to be installed
