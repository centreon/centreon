...
class FindServiceCategoryPresenterStub extends AbstractPresenter implements FindServiceCategoryPresenterInterface
{
    /**
     * @var FindServiceCategoryResponse
     */
    public $response;
    ...
    /**
     * @param FindServiceCategoryResponse $response
     */
