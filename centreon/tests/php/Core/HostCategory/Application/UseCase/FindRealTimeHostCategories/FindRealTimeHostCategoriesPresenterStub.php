...
class FindRealTimeHostCategoriesPresenterStub extends AbstractPresenter implements FindRealTimeHostCategoriesPresenterInterface
{
    public FindRealTimeHostCategoriesResponse|ResponseStatusInterface $response;
