...
class FindContactDashboardSharesPresenterStub implements FindContactDashboardSharesPresenterInterface
{
    public FindContactDashboardSharesResponse|ResponseStatusInterface $data;
