...
class AddContactGroupDashboardSharePresenterStub implements AddContactGroupDashboardSharePresenterInterface
{
    public AddContactGroupDashboardShareResponse|ResponseStatusInterface $data;
