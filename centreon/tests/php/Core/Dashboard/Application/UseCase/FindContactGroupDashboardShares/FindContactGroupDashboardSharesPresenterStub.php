...
class FindContactGroupDashboardSharesPresenterStub implements FindContactGroupDashboardSharesPresenterInterface
{
    public FindContactGroupDashboardSharesResponse|ResponseStatusInterface $data;
