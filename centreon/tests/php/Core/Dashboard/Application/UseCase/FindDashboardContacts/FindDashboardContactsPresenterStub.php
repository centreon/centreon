...
class FindDashboardContactsPresenterStub implements FindDashboardContactsPresenterInterface
{
    public FindDashboardContactsResponse|ResponseStatusInterface $data;
