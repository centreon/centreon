...
namespace Tests\Core\Service\Infrastructure\API\GetService;
...
class GetServicePresenterStub extends AbstractPresenter implements GetServicePresenterInterface
{
    public ResponseStatusInterface|GetServiceResponse $response;
