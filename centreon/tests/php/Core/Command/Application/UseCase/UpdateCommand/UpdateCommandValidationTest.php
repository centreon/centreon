...
beforeEach(function (): void {
    $this->validation = new UpdateCommandValidator(
...
it('throws an exception when name is already used', function (): void {
    $request = new UpdateCommandRequest();
    ...
    $this->validation->assertNameDoesNotAlreadyExists($command, $request->name);
})->throws(
    CommandException::class,
    CommandException::nameAlreadyExists('new name')->getMessage()
);
