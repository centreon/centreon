...
class FindAdditionalConnectorPresenterStub implements FindAdditionalConnectorPresenterInterface
{
    public FindAdditionalConnectorResponse|ResponseStatusInterface $data;
