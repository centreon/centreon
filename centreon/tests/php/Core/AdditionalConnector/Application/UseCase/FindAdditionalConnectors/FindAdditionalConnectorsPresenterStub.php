...
class FindAdditionalConnectorsPresenterStub implements FindAdditionalConnectorsPresenterInterface
{
    public FindAdditionalConnectorsResponse|ResponseStatusInterface $data;

    public function presentResponse(FindAdditionalConnectorsResponse|ResponseStatusInterface $data): void
    {
        $this->data = $data;
    }
}
