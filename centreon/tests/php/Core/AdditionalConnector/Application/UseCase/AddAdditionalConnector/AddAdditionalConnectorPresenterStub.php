...
class AddAdditionalConnectorPresenterStub implements AddAdditionalConnectorPresenterInterface
{
    public AddAdditionalConnectorResponse|ResponseStatusInterface $data;
