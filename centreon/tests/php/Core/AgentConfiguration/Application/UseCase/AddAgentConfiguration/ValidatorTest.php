...
it('should throw an exception when the AC type is already associated to one of the pollers', function (): void {
    $this->readAgentConfigurationRepository
        ->expects($this->once())
    ...
    $this->validator->validateTypeOrFail($this->request);
})->throws(AgentConfigurationException::alreadyAssociatedPollers(Type::TELEGRAF, [1])->getMessage());
