...
use App\MonitoringConfiguration\Infrastructure\ApiPlatform\State\Timezone\TimezoneResourceTransformer;
use PHPUnit\Framework\TestCase;

final class TimezoneResourceTransformerTest extends TestCase
{
    public function testTransformMapsTheAggregateToTheResource(): void
    {
        $resource = (new TimezoneResourceTransformer())->transform(
            new Timezone(new TimezoneId(42), new TimezoneName('Europe/Paris'))
        );

        self::assertSame(42, $resource->id);
        self::assertSame('Europe/Paris', $resource->name);
    }
}
