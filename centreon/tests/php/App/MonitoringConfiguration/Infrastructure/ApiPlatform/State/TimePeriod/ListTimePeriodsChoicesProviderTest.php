...
final class ListTimePeriodsChoicesProviderTest extends ApiTestCase
{
    private const BASE_ENDPOINT = '/api/configuration/hosts/timeperiods';
    ...
    public function testItListsTimePeriodsForAUserGrantedTheHostReadWriteTopologyRole(): void
    {
        $name = "hosttp-{$this->tag}";
        ...
        // proves the point of the endpoint: filling a host's check and notification periods
        // needs no time period role of its own
    ...
    public function testItRejectsAScalarNameFilter(): void
    {
        ...
        $this->request('GET', self::BASE_ENDPOINT, ['query' => ['name' => "hosttp-{$this->tag}"]]);
