Feature:
  ...
  Scenario: Find performances metrics for panel edition
    ...
    And the JSON node "metrics[0].data" should have at least 5 elements
    And the JSON node "metrics[1].data" should have at least 5 elements
    And the JSON node "metrics[2].data" should have at least 5 elements
    And the JSON node "times" should have at least 5 elements
