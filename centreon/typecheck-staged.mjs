...
const stagedPathPrefix = `${packageRelToRepo}/www/front_src/src`;

// Mirror exclusions from tsconfig.typecheck.json so the hook stays consistent
// with `pnpm type-check` / the CI job.
...
const ambientIncludes = ['./types/**/*.d.ts', './www/front_src/src/**/*.d.ts'];
