...
var cypress_esbuild_preprocessor_1 = require("@bahmutov/cypress-esbuild-preprocessor");
var esbuild_1 = require("@badeball/cypress-cucumber-preprocessor/esbuild");
exports.default = (function (on, config) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, cypress_cucumber_preprocessor_1.addCucumberPreprocessorPlugin)(on, config)];
            case 1:
                _a.sent();
                on('file:preprocessor', (0, cypress_esbuild_preprocessor_1.default)({
                    plugins: [
                        (0, esbuild_1.default)(config),
