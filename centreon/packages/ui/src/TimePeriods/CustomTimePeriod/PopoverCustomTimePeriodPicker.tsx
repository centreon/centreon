...
const PopoverCustomTimePeriodPickers = ({
  ...
  renderFooter,
  pickersData,
  errorMessage = labelEndDateGreaterThanStartDate,
      ...
      <div className={classNamePaper} data-testid="popover">
        ...
        >
          <div className={classNamePicker}>
            <Typography>{labelTimePeriodPicker.labelFrom}</Typography>
            <div aria-label={labelTimePeriodPicker.labelEnd}>
              <DateTimePickerInput
            ...
            <Typography>{labelTimePeriodPicker.labelEnd}</Typography>
            <div aria-label={labelTimePeriodPicker.labelEnd}>
              <DateTimePickerInput
                changeDate={changeDate}
                date={end}
