...
describe('Line chart', () => {
  ...
  describe('Axis', () => {
    ...
    it('rotates the tick label when the props is set', () => {
      ...
      cy.get('text[transform="rotate(-35, -2, 145.35558407856539)"]').should(
        'be.visible'
      );
  ...
  describe('Line style', () => {
    ...
    it('shows points when the prop is set', () => {
      ...
      cy.get('circle[cy="51.94254701942642"]').should('be.visible');
...
describe('Lines and bars', () => {
  ...
  it('displays stacked lines and bars when a line and a bar are customized', () => {
    ...
    cy.get(
      'path[d="M7.4462809917355415,255.30136945461638 h56.016528925619824 h1v1 v119.69863054538362 a1,1 0 0 1 -1,1 h-56.016528925619824 a1,1 0 0 1 -1,-1 v-119.69863054538362 v-1h1z"]'
    ).should('be.visible');
    cy.get(
      'path[d="M23.85123966942149,125.64455442935 h23.20661157024793 a17.404958677685947,17.404958677685947 0 0 1 17.404958677685947,17.404958677685947 v94.84689766989449 v17.404958677685947h-17.404958677685947 h-23.20661157024793 h-17.404958677685947v-17.404958677685947 v-94.84689766989449 a17.404958677685947,17.404958677685947 0 0 1 17.404958677685947,-17.404958677685947z"]'
    ).should('be.visible');
