...
CREATE INDEX `level_index` ON `hostcategories` (`level`);
ALTER TABLE `acl_resources_hc_relations` ADD CONSTRAINT `acl_resources_hc_relations_pk` UNIQUE (`hc_id`, `acl_res_id`);
