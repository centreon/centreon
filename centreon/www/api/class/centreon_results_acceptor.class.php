                    ...
                    if (!isset($this->hostServices[$data['host']]) ||
                        ...
                        if (!isset($this->pollerHosts['name'][$data['host']])) {
                            ...
                            $ret = [
                                ...
                                'host_active_checks_enabled' => ['host_active_checks_enabled', 0],
                                'host_passive_checks_enabled' => ['host_passive_checks_enabled' => 1],
                                'host_retry_check_interval' => 1,
                                'host_max_check_attempts' => 3,
                                'host_register' => 1,
                                'host_activate' => ['host_activate' => 1],
                        ...
                        if (!isset($this->hostServices[$data['host']][$data["service"]])) {
                            ...
                            $ret = [
                                ...
                                'service_active_checks_enabled' => ['service_active_checks_enabled' => 0],
                                'service_passive_checks_enabled' => ['service_passive_checks_enabled' => 1],
                                'service_register' => 1,
                                'service_activate' => ['service_activate' => 1],
