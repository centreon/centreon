import { labelContactGroup } from '../shared/translatedLabels';
...
export const labelBaseUrl = 'Base URL';
export const labelAuthorizationEndpoint = 'Authorization endpoint';
export const labelTokenEndpoint = 'Token endpoint';
export const labelIntrospectionTokenEndpoint = 'Introspection token endpoint';
...
export const labelUseBasicAuthenticatonForTokenEndpointAuthentication =
  'Use basic authentication for token endpoint authentication';
