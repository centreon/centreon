...
export const labelDatasetSelection = 'Dataset selection';
...
export const labelRefineFiltersToNarrowDownResources =
  'Add filters to narrow down your selection of resources';
