...
const getViewByService = (color: string, backgroundColor: string): string =>
...
const getViewByHost = (color: string, backgroundColor: string): string =>
...
const getViewByAll = (color: string, backgroundColor: string): string =>
