export const labelExportConfiguration = 'Export configuration';
...
export const labelPollerAddress = 'Poller address';
export const labelCentralAddress =
  'Centreon Central address, as seen by this poller';
