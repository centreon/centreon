...
foreach (['o1', 'o2'] as $option) {
    ...
    $attrs = [
        ...
        'data-title-delete' => _('Delete broker configuration'),
        'data-msg-delete' => _('You are about to delete the selected broker configuration(s). This action cannot be undone. Do you want to delete?'),
        'data-label-delete' => _('Delete'),
        'data-title-duplicate' => _('Duplicate broker configuration'),
        'data-msg-duplicate' => _('Do you want to duplicate the selected broker configuration(s)?'),
...
$tpl->assign('welcomeTitleJs', json_encode(_('Welcome to the broker configuration page'), $welcomeJsonFlags));
$tpl->assign('welcomeDescJs', json_encode(_('Configure how monitoring data is collected and forwarded.'), $welcomeJsonFlags));
$tpl->assign('welcomeCtaJs', json_encode(_('Add broker configuration'), $welcomeJsonFlags));
