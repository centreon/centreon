...
foreach (['o1', 'o2'] as $option) {
    ...
    $attrs = [
        ...
        'data-title-delete' => _('Delete poller configuration'),
        'data-msg-delete' => _('You are about to delete the selected poller configuration(s). This action cannot be undone. Do you want to delete?'),
        'data-label-delete' => _('Delete'),
        'data-title-duplicate' => _('Duplicate poller configuration'),
        'data-msg-duplicate' => _('Do you want to duplicate the selected poller configuration(s)?'),
...
$tpl->assign('welcomeTitleJs', json_encode(_('Welcome to the engine configuration page'), $welcomeJsonFlags));
$tpl->assign('welcomeDescJs', json_encode(_('Configure the monitoring engine settings applied to your pollers.'), $welcomeJsonFlags));
$tpl->assign('welcomeCtaJs', json_encode(_('Add engine configuration'), $welcomeJsonFlags));
