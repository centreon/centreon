...
foreach (['o1', 'o2'] as $option) {
    ...
    $attrs = [
        ...
        'data-title-delete' => _('Delete resource'),
        'data-msg-delete' => _('You are about to delete the selected resource(s). This action cannot be undone. Do you want to delete?'),
        'data-label-delete' => _('Delete'),
        'data-title-duplicate' => _('Duplicate resource'),
        'data-msg-duplicate' => _('Do you want to duplicate the selected resource(s)?'),
...
$tpl->assign('welcomeTitleJs', json_encode(_('Welcome to the resources page'), $welcomeJsonFlags));
$tpl->assign('welcomeDescJs', json_encode(_('Define resource macros ($USER$) reused across your configuration.'), $welcomeJsonFlags));
$tpl->assign('welcomeCtaJs', json_encode(_('Add resource macro'), $welcomeJsonFlags));
