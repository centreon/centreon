...
$tpl->assign('welcomeTitleJs', json_encode(_('Welcome to the time periods page'), $welcomeJsonFlags));
$tpl->assign('welcomeDescJs', json_encode(_('Define time ranges used to schedule checks and notifications.'), $welcomeJsonFlags));
$tpl->assign('welcomeCtaJs', json_encode(_('Add time period'), $welcomeJsonFlags));
