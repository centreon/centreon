...
foreach (['o1'] as $option) {
    ...
    $attrs = [
        ...
        'data-title-delete-one' => _('Delete time period'),
        'data-title-delete-many' => _('Delete time periods'),
        'data-msg-delete-one' => _('You are about to delete the <strong>{{ name }}</strong> time period. This action cannot be undone. Do you want to delete it?'),
        'data-msg-delete-many' => _('You are about to delete <strong>{{ count }} time periods.</strong> This action cannot be undone. Do you want to delete them?'),
        'data-label-delete' => _('Delete'),
        'data-title-duplicate-one' => _('Duplicate time period'),
        'data-title-duplicate-many' => _('Duplicate time periods'),
        'data-msg-duplicate-one' => _('You are about to duplicate the <strong>{{ name }}</strong> time period. Do you want to duplicate it?'),
        'data-msg-duplicate-many' => _('You are about to duplicate <strong>{{ count }} time periods.</strong> Do you want to duplicate them?'),
