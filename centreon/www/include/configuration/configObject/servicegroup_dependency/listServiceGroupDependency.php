...
foreach (['o1', 'o2'] as $option) {
    ...
    $attrs = [
        ...
        'data-title-delete' => _('Delete service group dependency'),
        'data-msg-delete' => _('You are about to delete the selected service group dependency(s). This action cannot be undone. Do you want to delete?'),
        'data-label-delete' => _('Delete'),
        'data-title-duplicate' => _('Duplicate service group dependency'),
        'data-msg-duplicate' => _('Do you want to duplicate the selected service group dependency(s)?'),
...
$tpl->assign('welcomeTitleJs', json_encode(_('Welcome to the service group dependencies page'), $welcomeJsonFlags));
$tpl->assign('welcomeDescJs', json_encode(_('Suppress notifications based on the state of other service groups.'), $welcomeJsonFlags));
$tpl->assign('welcomeCtaJs', json_encode(_('Add service group dependency'), $welcomeJsonFlags));
