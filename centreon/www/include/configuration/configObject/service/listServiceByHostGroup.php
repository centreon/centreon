...
$tpl->assign('welcomeTitleJs', json_encode(_('Welcome to the services by host group page'), $welcomeJsonFlags));
$tpl->assign('welcomeDescJs', json_encode(_('Configure services grouped by host group.'), $welcomeJsonFlags));
