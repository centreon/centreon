...
foreach (['o1', 'o2'] as $option) {
    ...
    $attrs = [
        ...
        'data-title-delete' => _('Delete host dependency'),
        'data-msg-delete' => _('You are about to delete the selected host dependency(s). This action cannot be undone. Do you want to delete?'),
        'data-label-delete' => _('Delete'),
        'data-title-duplicate' => _('Duplicate host dependency'),
        'data-msg-duplicate' => _('Do you want to duplicate the selected host dependency(s)?'),
...
$tpl->assign('welcomeTitleJs', json_encode(_('Welcome to the host dependencies page'), $welcomeJsonFlags));
$tpl->assign('welcomeDescJs', json_encode(_('Suppress host notifications based on the state of other hosts.'), $welcomeJsonFlags));
$tpl->assign('welcomeCtaJs', json_encode(_('Add host dependency'), $welcomeJsonFlags));
