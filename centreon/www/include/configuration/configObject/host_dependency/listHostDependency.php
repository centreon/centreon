...
for ($i = 0; $dep = $dbResult->fetch(); $i++) {
    ...
    $moptions .= "&nbsp;<input onKeypress=\"if(event.keyCode > 31 && (event.keyCode < 45 || event.keyCode > 57)) " .
        ...
        $dep['dep_id'] . "]' />";
    $elemArr[$i] = ["MenuClass" => "list_" . $style, "RowMenu_select" => $selectedElements->toHtml(), "RowMenu_name" => CentreonUtils::escapeSecure(myDecode($dep["dep_name"])), "RowMenu_description" => CentreonUtils::escapeSecure(myDecode($dep["dep_description"])), "RowMenu_link" => "main.php?p=" . $p . "&o=c&dep_id=" . $dep['dep_id'], "RowMenu_options" => $moptions];
