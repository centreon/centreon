...
foreach (['o1', 'o2'] as $option) {
    ...
    $attrs = [
        ...
        'data-title-delete' => _('Delete contact template'),
        'data-msg-delete' => _('You are about to delete the selected contact template(s). This action cannot be undone. Do you want to delete?'),
        'data-label-delete' => _('Delete'),
        'data-title-duplicate' => _('Duplicate contact template'),
        'data-msg-duplicate' => _('Do you want to duplicate the selected contact template(s)?'),
