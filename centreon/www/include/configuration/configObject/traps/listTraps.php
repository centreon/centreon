...
$tpl->assign('welcomeTitleJs', json_encode(_('Welcome to the SNMP traps page'), $welcomeJsonFlags));
$tpl->assign('welcomeDescJs', json_encode(_('Configure the SNMP traps received and processed by your platform.'), $welcomeJsonFlags));
$tpl->assign('welcomeCtaJs', json_encode(_('Add SNMP trap'), $welcomeJsonFlags));
