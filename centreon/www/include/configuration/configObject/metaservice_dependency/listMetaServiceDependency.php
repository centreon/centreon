...
foreach (['o1', 'o2'] as $option) {
    ...
    $attrs = [
        ...
        'data-title-delete' => _('Delete meta service dependency'),
        'data-msg-delete' => _('You are about to delete the selected meta service dependency(s). This action cannot be undone. Do you want to delete?'),
        'data-label-delete' => _('Delete'),
        'data-title-duplicate' => _('Duplicate meta service dependency'),
        'data-msg-duplicate' => _('Do you want to duplicate the selected meta service dependency(s)?'),
...
$tpl->assign('welcomeTitleJs', json_encode(_('Welcome to the meta service dependencies page'), $welcomeJsonFlags));
$tpl->assign('welcomeDescJs', json_encode(_('Suppress notifications based on the state of other meta services.'), $welcomeJsonFlags));
$tpl->assign('welcomeCtaJs', json_encode(_('Add meta service dependency'), $welcomeJsonFlags));
