...
foreach (['o1', 'o2'] as $option) {
    ...
    $attrs = [
        ...
        'data-title-delete' => _('Delete contact group'),
        'data-msg-delete' => _('You are about to delete the selected contact group(s). This action cannot be undone. Do you want to delete?'),
        'data-label-delete' => _('Delete'),
        'data-title-duplicate' => _('Duplicate contact group'),
        'data-msg-duplicate' => _('Do you want to duplicate the selected contact group(s)?'),
...
$tpl->assign('welcomeTitleJs', json_encode(_('Welcome to the contact groups page'), $welcomeJsonFlags));
$tpl->assign('welcomeDescJs', json_encode(_('Group contacts together to manage notifications collectively.'), $welcomeJsonFlags));
$tpl->assign('welcomeCtaJs', json_encode(_('Add contact group'), $welcomeJsonFlags));
