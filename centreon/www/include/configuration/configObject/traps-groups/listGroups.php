...
foreach (['o1'] as $option) {
    ...
    $attrs = [
        ...
        'data-title-delete-one' => _('Delete trap group'),
        'data-title-delete-many' => _('Delete trap groups'),
        'data-msg-delete-one' => _('You are about to delete the <strong>{{ name }}</strong> trap group. This action cannot be undone. Do you want to delete it?'),
        'data-msg-delete-many' => _('You are about to delete <strong>{{ count }} trap groups.</strong> This action cannot be undone. Do you want to delete them?'),
        'data-label-delete' => _('Delete'),
        'data-title-duplicate-one' => _('Duplicate trap group'),
        'data-title-duplicate-many' => _('Duplicate trap groups'),
        'data-msg-duplicate-one' => _('You are about to duplicate the <strong>{{ name }}</strong> trap group. Do you want to duplicate it?'),
        'data-msg-duplicate-many' => _('You are about to duplicate <strong>{{ count }} trap groups.</strong> Do you want to duplicate them?'),
