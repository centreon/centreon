...
foreach (['o1', 'o2'] as $option) {
    ...
    $attrs = [
        ...
        'data-title-delete' => _('Delete service dependency'),
        'data-msg-delete' => _('You are about to delete the selected service dependency(s). This action cannot be undone. Do you want to delete?'),
        'data-label-delete' => _('Delete'),
        'data-title-duplicate' => _('Duplicate service dependency'),
        'data-msg-duplicate' => _('Do you want to duplicate the selected service dependency(s)?'),
