...
foreach (['o1'] as $option) {
    ...
    $attrs = [
        ...
        'data-title-delete-one' => _('Delete service dependency'),
        'data-title-delete-many' => _('Delete service dependencies'),
        'data-msg-delete-one' => _('You are about to delete the <strong>{{ name }}</strong> service dependency. This action cannot be undone. Do you want to delete it?'),
        'data-msg-delete-many' => _('You are about to delete <strong>{{ count }} service dependencies.</strong> This action cannot be undone. Do you want to delete them?'),
        'data-label-delete' => _('Delete'),
        'data-title-duplicate-one' => _('Duplicate service dependency'),
        'data-title-duplicate-many' => _('Duplicate service dependencies'),
        'data-msg-duplicate-one' => _('You are about to duplicate the <strong>{{ name }}</strong> service dependency. Do you want to duplicate it?'),
        'data-msg-duplicate-many' => _('You are about to duplicate <strong>{{ count }} service dependencies.</strong> Do you want to duplicate them?'),
