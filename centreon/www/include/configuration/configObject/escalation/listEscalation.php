...
foreach (['o1', 'o2'] as $option) {
    ...
    $attrs = [
        ...
        'data-title-delete' => _('Delete escalation'),
        'data-msg-delete' => _('You are about to delete the selected escalation(s). This action cannot be undone. Do you want to delete?'),
        'data-label-delete' => _('Delete'),
        'data-title-duplicate' => _('Duplicate escalation'),
        'data-msg-duplicate' => _('Do you want to duplicate the selected escalation(s)?'),
