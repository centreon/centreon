...
foreach (['o1'] as $option) {
    ...
    $attrs = [
        ...
        'data-title-delete-one' => _('Delete escalation'),
        'data-title-delete-many' => _('Delete escalations'),
        'data-msg-delete-one' => _('You are about to delete the <strong>{{ name }}</strong> escalation. This action cannot be undone. Do you want to delete it?'),
        'data-msg-delete-many' => _('You are about to delete <strong>{{ count }} escalations.</strong> This action cannot be undone. Do you want to delete them?'),
        'data-label-delete' => _('Delete'),
        'data-title-duplicate-one' => _('Duplicate escalation'),
        'data-title-duplicate-many' => _('Duplicate escalations'),
        'data-msg-duplicate-one' => _('You are about to duplicate the <strong>{{ name }}</strong> escalation. Do you want to duplicate it?'),
        'data-msg-duplicate-many' => _('You are about to duplicate <strong>{{ count }} escalations.</strong> Do you want to duplicate them?'),
