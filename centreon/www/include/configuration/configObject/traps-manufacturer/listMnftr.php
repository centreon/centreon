...
$tpl->assign('welcomeTitleJs', json_encode(_('Welcome to the trap vendors page'), $welcomeJsonFlags));
$tpl->assign('welcomeDescJs', json_encode(_('Manage the vendors that group your SNMP trap definitions.'), $welcomeJsonFlags));
$tpl->assign('welcomeCtaJs', json_encode(_('Add trap vendor'), $welcomeJsonFlags));
