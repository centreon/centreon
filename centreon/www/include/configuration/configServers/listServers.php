...
if (! $isRemote) {
    ...
    $attrs = [
        ...
        'data-title-delete' => _('Delete poller'),
        'data-msg-delete' => _('You are about to delete the selected poller(s). This action cannot be undone. Do you want to delete?'),
        'data-label-delete' => _('Delete'),
        'data-title-duplicate' => _('Duplicate poller'),
        'data-msg-duplicate' => _('Do you want to duplicate the selected poller(s)?'),
