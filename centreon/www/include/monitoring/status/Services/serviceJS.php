...
<script type="text/javascript">
    ...
    function getCheckedList(_input_name) {
        ...
        for (var i = 0; i < mesinputs.length; i++) {
            if (mesinputs[i].type.toLowerCase() == 'checkbox' &&
                mesinputs[i].checked && mesinputs[i].name.substr(0, 6) == _input_name
            ) {
    ...
    function send_the_command() {
        ...
        if (_cmd == '70' || _cmd == '72') {
            ...
            if (searchElement.find('#downtimehostservice').length &&
                searchElement.find('#downtimehostservice').is(':checked')
            ) {
            ...
            if (searchElement.find('[name="host_or_centreon_time"]').length &&
                searchElement.find('[name="host_or_centreon_time"]').is(':checked')
            ) {
