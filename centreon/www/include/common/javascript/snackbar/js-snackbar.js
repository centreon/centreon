    ...
    function _createMessage() {
        ...
        function getStyleColor() {
            switch (_Options.status)
            {
                case "success":
                case "green":
                    return "js-snackbar--success";
                case "warning":
                case "alert":
                case "orange":
                    return "js-snackbar--warning";
                case "danger":
                case "error":
                case "red":
                    return "js-snackbar--danger";
                default:
                    return "js-snackbar--info";
            }
        }

        function createInnerSnackbar() {
            var innerSnack = document.createElement("div");
            innerSnack.classList.add("js-snackbar", getStyleColor());
        ...
        function applyColorAndIconTo(element) {
            ...
            function applyColorTo(element) {
                element.classList.add(getStyleColor());
            }
        ...
        function addDismissButtonTo(element) {
            ...
            closeButton.classList.add("js-snackbar__close", getStyleColor());
