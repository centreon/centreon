...
$attrs = [
    ...
    'data-title-delete' => _('Delete virtual metric'),
    'data-msg-delete' => _('You are about to delete the selected virtual metric(s). This action cannot be undone. Do you want to delete?'),
    'data-label-delete' => _('Delete'),
    'data-title-duplicate' => _('Duplicate virtual metric'),
    'data-msg-duplicate' => _('Do you want to duplicate the selected virtual metric(s)?'),
