...
$form->registerRule('lessThan', 'callback', 'isLessThanEqual');
...
$form->addRule('AjaxTimeReloadMonitoring', _('The maximum allowed value is 3600'), 'lessThan', 3600);
...
$form->addRule('AjaxTimeReloadStatistic', _('The maximum allowed value is 3600'), 'lessThan', 3600);
