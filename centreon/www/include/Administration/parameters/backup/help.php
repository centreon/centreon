...
$help['tip_backup_configuration_files'] = dgettext(
    'help',
    'Backup configuration files (MySQL, Apache, PHP, SNMP, centreon, centreon-engine, centreon-broker)'
);
...
$help['tip_backup_mysql_conf'] = dgettext(
    'help',
    'MySQL configuration file path (e.g. /etc/my.cnf.d/centreon.cnf); leave empty to use the default'
);
