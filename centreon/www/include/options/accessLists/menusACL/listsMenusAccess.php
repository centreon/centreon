...
foreach (['o1', 'o2'] as $option) {
    ...
    $attrs = [
        ...
        'data-title-delete' => _('Delete menu access rule'),
        'data-msg-delete' => _('You are about to delete the selected menu access rule(s). This action cannot be undone. Do you want to delete?'),
        'data-label-delete' => _('Delete'),
        'data-title-duplicate' => _('Duplicate menu access rule'),
        'data-msg-duplicate' => _('Do you want to duplicate the selected menu access rule(s)?'),
...
$tpl->assign('welcomeTitleJs', json_encode(_('Welcome to the menu access page'), $welcomeJsonFlags));
$tpl->assign('welcomeDescJs', json_encode(_('Control which configuration menus each access group can see.'), $welcomeJsonFlags));
$tpl->assign('welcomeCtaJs', json_encode(_('Add menu access'), $welcomeJsonFlags));
