...
foreach (['o1', 'o2'] as $option) {
    ...
    $attrs = [
        ...
        'data-title-delete' => _('Delete action access rule'),
        'data-msg-delete' => _('You are about to delete the selected action access rule(s). This action cannot be undone. Do you want to delete?'),
        'data-label-delete' => _('Delete'),
        'data-title-duplicate' => _('Duplicate action access rule'),
        'data-msg-duplicate' => _('Do you want to duplicate the selected action access rule(s)?'),
...
$tpl->assign('welcomeTitleJs', json_encode(_('Welcome to the actions access page'), $welcomeJsonFlags));
$tpl->assign('welcomeDescJs', json_encode(_('Control which monitoring actions each access group can perform.'), $welcomeJsonFlags));
$tpl->assign('welcomeCtaJs', json_encode(_('Add actions access'), $welcomeJsonFlags));
