...
foreach (['o1', 'o2'] as $option) {
    ...
    $attrs = [
        ...
        'data-title-delete' => _('Delete resource access rule'),
        'data-msg-delete' => _('You are about to delete the selected resource access rule(s). This action cannot be undone. Do you want to delete?'),
        'data-label-delete' => _('Delete'),
        'data-title-duplicate' => _('Duplicate resource access rule'),
        'data-msg-duplicate' => _('Do you want to duplicate the selected resource access rule(s)?'),
...
$tpl->assign('welcomeTitleJs', json_encode(_('Welcome to the resource access page'), $welcomeJsonFlags));
$tpl->assign('welcomeDescJs', json_encode(_('Define which resources each access group can access.'), $welcomeJsonFlags));
$tpl->assign('welcomeCtaJs', json_encode(_('Add resource access'), $welcomeJsonFlags));
