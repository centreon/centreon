...
foreach (['o1', 'o2'] as $option) {
    ...
    $attrs = [
        ...
        'data-title-delete' => _('Delete access group'),
        'data-msg-delete' => _('You are about to delete the selected access group(s). This action cannot be undone. Do you want to delete?'),
        'data-label-delete' => _('Delete'),
        'data-title-duplicate' => _('Duplicate access group'),
        'data-msg-duplicate' => _('Do you want to duplicate the selected access group(s)?'),
...
$tpl->assign('welcomeTitleJs', json_encode(_('Welcome to the access groups page'), $welcomeJsonFlags));
$tpl->assign('welcomeDescJs', json_encode(_('Define access groups to assign permissions to your users.'), $welcomeJsonFlags));
$tpl->assign('welcomeCtaJs', json_encode(_('Add access group'), $welcomeJsonFlags));
