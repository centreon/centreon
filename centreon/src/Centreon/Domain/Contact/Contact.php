...
class Contact implements UserInterface, ContactInterface
{
    ...
    public const ROLE_CONFIGURATION_CONTACTS_TEMPLATES_READ = 'ROLE_CONFIGURATION_USERS_CONTACTS_TEMPLATES_R';
    public const ROLE_CONFIGURATION_CONTACTS_TEMPLATES_READ_WRITE = 'ROLE_CONFIGURATION_USERS_CONTACT_TEMPLATES_RW';
