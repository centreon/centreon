...
class Contact implements UserInterface, ContactInterface
{
    ...
    public const ROLE_CONFIGURATION_ACC_RW = 'ROLE_CONFIGURATION_ADDITIONAL_CONNECTOR_CONFIGURATIONS_RW';
    public const ROLE_CONFIGURATION_POLLERS_AGENT_CONFIGURATIONS_RW = 'ROLE_CONFIGURATION_POLLERS_AGENT_CONFIGURATION_RW';
