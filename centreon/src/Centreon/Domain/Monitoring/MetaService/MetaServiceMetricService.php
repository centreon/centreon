...
class MetaServiceMetricService implements MetaServiceMetricServiceInterface
{
     ...
     */
    public function __construct(private MetaServiceMetricRepositoryInterface $repository, private MetaServiceConfigurationServiceInterface $metaServiceConfigurationService, private ContactInterface $contact)
    {
    }
