...
#[IsGranted(
    HostGroupVoters::HOSTGROUP_ENABLE_DISABLE,
    null,
    'You are not allowed to enable or disable host groups',
    Response::HTTP_FORBIDDEN
)]
final class EnableDisableHostGroupsController extends AbstractController
{
