...
class EnableDisableHostGroupsStatusResponseNormalizer implements NormalizerInterface
{
    use LoggerTrait;
    ...
    /**
     * @param EnableDisableHostGroupsStatusResponse $object
    ...
    {
        return $data instanceof EnableDisableHostGroupsStatusResponse;
    }
