...
class DuplicateHostGroupsStatusResponseNormalizer implements NormalizerInterface
{
    use LoggerTrait;
    ...
    /**
     * @param DuplicateHostGroupsStatusResponse $object
    ...
    {
        return $data instanceof DuplicateHostGroupsStatusResponse;
    }
