...
class DbWriteUserRepository extends AbstractRepositoryDRB implements WriteUserRepositoryInterface
{
    ...
    public function update(User $user): void
    {
        ...
        $statement->bindValue(':viewMode', $user->getViewMode(), \PDO::PARAM_STR);
    ...
    public function create(NewUser $user): void
    {
        $statement = $this->db->prepare(
            $this->translateDbName(
                'INSERT INTO `:db`.contact
                    ...
                    contact_admin, contact_theme, contact_view_mode, contact_activate)
                    VALUES (:contactName, :contactAlias, :contactEmail, :contactTemplateId,
                    :isAdmin, :contactTheme, :contactViewMode, :isActivate)'
            )
        );
        ...
        $statement->bindValue(':contactViewMode', $user->getViewMode(), \PDO::PARAM_STR);
