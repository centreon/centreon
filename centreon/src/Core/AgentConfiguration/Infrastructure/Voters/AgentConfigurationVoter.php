...
final class AgentConfigurationVoter extends Voter
{
    ...
    public const READ_AC_AVAILABLE_POLLERS = 'read_agent_configuration_available_pollers';
    ...
    {
        if ($attribute === self::READ_AC || $attribute === self::READ_AC_AVAILABLE_POLLERS) {
            return $subject === null;
        }
    ...
    protected function voteOnAttribute(string $attribute, $subject, TokenInterface $token): bool
    {
        ...
        return match ($attribute) {
            self::READ_AC, self::READ_AC_AVAILABLE_POLLERS => $this->checkTopologyRole($user),
