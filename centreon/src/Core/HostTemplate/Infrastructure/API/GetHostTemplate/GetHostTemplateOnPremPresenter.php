...
namespace Core\HostTemplate\Infrastructure\API\GetHostTemplate;
...
class GetHostTemplateOnPremPresenter extends AbstractPresenter implements GetHostTemplatePresenterInterface
{
    use PresenterTrait;
     ...
     * @inheritDoc
     */
    public function presentResponse(GetHostTemplateResponse|ResponseStatusInterface $response): void
    {
