...
namespace Core\Command\Infrastructure\API\GetCommand;
...
class GetCommandPresenter extends AbstractPresenter implements GetCommandPresenterInterface
{
    use PresenterTrait;
     ...
     * @inheritDoc
     */
    public function presentResponse(GetCommandResponse|ResponseStatusInterface $response): void
    {
