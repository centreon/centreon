...
final class GetServiceController extends AbstractController
{
    /**
     * @param GetService $useCase
     * @param GetServiceOnPremPresenter $onPremPresenter
     * @param GetServiceSaasPresenter $saasPresenter
