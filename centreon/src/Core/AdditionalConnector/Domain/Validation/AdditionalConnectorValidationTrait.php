...
namespace Core\AdditionalConnector\Domain\Validation;
 ...
 *
 * It gathers all the guard methods of common fields from {@see AdditionalConnector} and {@see NewAdditionalConnector} entities.
 */
trait AdditionalConnectorValidationTrait
{
    /**
     * @param string $name
     *
    ...
    private function ensureValidName(string $name): void
    {
        ...
        Assertion::maxLength($name, AdditionalConnector::MAX_NAME_LENGTH, $shortName . '::name');
    ...
    {
        $shortName = (new \ReflectionClass($this))->getShortName();
        Assertion::maxLength($description, AdditionalConnector::MAX_DESCRIPTION_LENGTH, $shortName . '::description');
    }
