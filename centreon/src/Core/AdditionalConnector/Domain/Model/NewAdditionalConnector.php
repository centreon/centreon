...
namespace Core\AdditionalConnector\Domain\Model;

use Assert\AssertionFailedException;
use Core\AdditionalConnector\Domain\Validation\AdditionalConnectorValidationTrait;

/**
 * @immutable
 */
class NewAdditionalConnector
{
    use AdditionalConnectorValidationTrait;
