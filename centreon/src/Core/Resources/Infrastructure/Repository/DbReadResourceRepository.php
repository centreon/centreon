...
class DbReadResourceRepository extends DatabaseRepository implements ReadResourceRepositoryInterface
{
    ...
    /** Stores the count query generated by generateFindResourcesRequest() for use by find(). */
    ...
    public function findParentResourcesById(ResourceFilter $filter): array
    {
        ...
        try {
            ...
            // get total without pagination using a separate COUNT query
            $queryTotal = $this->translateDbName($countQuery);
    ...
    private function find(string $query, QueryParameters $queryParametersFromRequestParameters): void
    {
        ...
        if ($this->countQuery !== null) {
            $queryTotal = $this->translateDbName($this->countQuery);
            if (($total = $this->connection->fetchOne($queryTotal, $queryParameters)) !== false) {
                $this->sqlRequestTranslator->getRequestParameters()->setTotal((int) $total);
            }
