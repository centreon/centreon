...
use Core\Application\Common\UseCase\GetResponse;
...
class GetHostOnPremPresenter extends AbstractPresenter implements GetHostPresenterInterface
{
    use PresenterTrait;
     ...
     * @inheritDoc
     */
    public function presentResponse(GetHostResponse|ResponseStatusInterface $response): void
    {
