...
abstract readonly class PartialUpdateDashboardRequestTransformer
{
    ...
    public static function transform(
        ...
        return new PartialUpdateDashboardRequest(
            ...
            panels: static::createPanelDto($dashboardInputValidator),
            refresh: static::createRefreshDto($dashboardInputValidator),
            thumbnail: static::createThumbnailDto($dashboardInputValidator)
        );
    }
