...
class ShareDashboardValidator
{
    ...
    public function validateDashboard(int $dashboardId): void
    {
        ...
        if ($this->rights->canCreate() && $this->readDashboardShareRepository->existAsEditor)
        //Validate Dashboard is shared as editor
    }

    public function validateContacts(array $contacts): void
    {
