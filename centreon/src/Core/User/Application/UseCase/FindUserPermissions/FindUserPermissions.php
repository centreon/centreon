...
use Core\User\Application\Model\Permission;
...
final class FindUserPermissions
{
    ...
    {
        return new FindUserPermissionsResponse([
            new Permission(
                new NotEmptyString('top-counter'), $user->isAdmin() || $user->hasRole(Contact::ROLE_DISPLAY_TOP_COUNTER)
            ),
        ]);
    }
}
