...
class FileProxyWriteMediaRepository implements WriteMediaRepositoryInterface
{
    public function __construct(
        ...
        readonly private FileDataStoreEngine $fileEngine,
    ) {
    }
    ...
    {
        $mediaId = $this->writeMediaRepository->add($media);
        $this->fileEngine->addFile($media->getFilepath() . DIRECTORY_SEPARATOR . $media->getFilename(), $media->getData());
