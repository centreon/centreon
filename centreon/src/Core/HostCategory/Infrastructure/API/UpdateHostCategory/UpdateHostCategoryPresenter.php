...
use Core\HostCategory\Application\UseCase\UpdateHostCategory\UpdateHostCategoryResponse;
use Core\Infrastructure\Common\Api\Router;
use Core\Infrastructure\Common\Presenter\PresenterFormatterInterface;

class UpdateHostCategoryPresenter extends AbstractPresenter
{
    use LoggerTrait;
    ...
    public function present(mixed $data): void
    {
        if (
            ...
            && $data->getPayload() instanceof UpdateHostCategoryResponse
        ) {
