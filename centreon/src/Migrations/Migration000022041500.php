...
class Migration000022041500 extends AbstractCoreMigration implements LegacyMigrationInterface
{
    use LoggerTrait;

    private const VERSION = '22.04.15';
    ...
    public function up(): void
    {
        ...
        $versionOfTheUpgrade = 'UPGRADE - 22.04.15: ';
        $errorMessage = '';
