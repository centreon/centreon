...
/**
 * @implements TransformerInterface<Plugin, PluginResource>
 */
final readonly class PluginTransformer implements TransformerInterface
{
    public function toResource(object $model): PluginResource
    {
        return new PluginResource(name: $model->name->value);
    }
}
