...
{
    private ?ServiceCategoryId $id = null;

    public function __construct(
        private ServiceCategoryName $name,
        private ServiceCategoryName $alias,
    ...
    public function name(): ServiceCategoryName
    {
        return $this->name;
    }

    public function alias(): ServiceCategoryName
    {
        return $this->alias;
    }
