...
namespace App\Monitoring\Infrastructure\Security;
 ...
 */
final class NotificationPermissionVoter extends Voter
{
    protected function supports(string $attribute, mixed $subject): bool
    {
        return NotificationPermissionEnum::tryFrom($attribute) !== null;
    }
