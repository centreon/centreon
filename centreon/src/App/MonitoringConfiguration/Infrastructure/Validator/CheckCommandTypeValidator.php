...
/**
 * Best-effort 422 existence + "must be a check command" check, mirroring AccessiblePollerValidator.
 * CreateHostCommandHandler's getById() remains the authoritative 404 guard.
 */
