...
/**
 * @extends Voter<value-of<TimePeriodPermissionEnum>, mixed>
 */
final class TimePeriodPermissionVoter extends Voter
{
    protected function supports(string $attribute, mixed $subject): bool
    {
        return TimePeriodPermissionEnum::tryFrom($attribute) !== null;
    }
