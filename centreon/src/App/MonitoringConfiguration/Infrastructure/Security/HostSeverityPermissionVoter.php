...
/**
 * @extends Voter<value-of<HostSeverityPermissionEnum>, mixed>
 */
final class HostSeverityPermissionVoter extends Voter
{
    protected function supports(string $attribute, mixed $subject): bool
    {
        return HostSeverityPermissionEnum::tryFrom($attribute) !== null;
    }
