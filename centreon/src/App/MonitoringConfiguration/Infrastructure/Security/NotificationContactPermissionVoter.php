...
/**
 * @extends Voter<value-of<NotificationContactPermissionEnum>, mixed>
 */
final class NotificationContactPermissionVoter extends Voter
{
    protected function supports(string $attribute, mixed $subject): bool
    {
        return NotificationContactPermissionEnum::tryFrom($attribute) !== null;
    }
