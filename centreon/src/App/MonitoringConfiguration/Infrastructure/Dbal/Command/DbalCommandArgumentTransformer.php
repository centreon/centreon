...
/**
 * @phpstan-import-type RowTypeAlias from DbalCommandArgumentRepository
 *
 * @implements TransformerInterface<RowTypeAlias, CommandArgument>
 */
final readonly class DbalCommandArgumentTransformer implements TransformerInterface
{
    public function transform(mixed $from): mixed
    {
        return new CommandArgument(
            name: new CommandArgumentName($from['macro_name']),
            description: new CommandArgumentDescription($from['macro_description']),
        );
    }
}
