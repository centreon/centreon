...
/**
 * @phpstan-import-type RowTypeAlias from DbalTimezoneRepository
 *
 * @implements TransformerInterface<RowTypeAlias, Timezone>
 */
final readonly class TimezoneTransformer implements TransformerInterface
{
    /**
    ...
    public function transform(mixed $from, array $extraData = []): Timezone
    {
        return new Timezone(
            ...
            name: new TimezoneName($from['name']),
        );
    }
}
