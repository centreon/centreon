...
use App\MonitoringConfiguration\Application\Query\ContactGroup\ListContactGroupsQuery;
...
final readonly class ListContactGroupsProvider implements ProviderInterface
{
    ...
    public function provide(Operation $operation, array $uriVariables = [], array $context = []): iterable
    {
        ...
        foreach ($this->handleOperatorFilter($filters['id'] ?? null, 'id', [ContactGroupCriteria::OPERATOR_EQUAL]) as $operator => $values) {
            foreach ($values as $value) {
