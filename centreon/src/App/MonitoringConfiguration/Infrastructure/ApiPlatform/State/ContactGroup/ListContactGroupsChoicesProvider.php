...
/**
 * @implements ProviderInterface<ContactGroupChoicesOutput>
 */
final readonly class ListContactGroupsChoicesProvider implements ProviderInterface
{
    use FilterAwareProviderTrait;

    /**
     * @param TransformerInterface<ContactGroup, ContactGroupChoicesOutput> $transformer
     */
    public function __construct(
        #[Autowire(service: ContactGroupChoicesTransformer::class)]
    ...
    /**
     * @return iterable<ContactGroupChoicesOutput>
     */
