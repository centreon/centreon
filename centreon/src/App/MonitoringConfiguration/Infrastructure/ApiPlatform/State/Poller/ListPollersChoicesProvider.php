...
/**
 * @implements ProviderInterface<PollerChoicesOutput>
 */
final readonly class ListPollersChoicesProvider implements ProviderInterface
{
    use FilterAwareProviderTrait;

    /**
     * @param TransformerInterface<Poller, PollerChoicesOutput> $transformer
     */
    public function __construct(
        #[Autowire(service: PollerChoicesTransformer::class)]
    ...
    /**
     * @return iterable<PollerChoicesOutput>
     */
    public function provide(Operation $operation, array $uriVariables = [], array $context = []): iterable
    {
        ...
        // Legacy's host-form poller select (getPollerString()) only offers active pollers, unlike
        // the generic /configuration/pollers endpoint, which returns pollers regardless of status.
        $criteria = $criteria->withActiveOnly(true);
