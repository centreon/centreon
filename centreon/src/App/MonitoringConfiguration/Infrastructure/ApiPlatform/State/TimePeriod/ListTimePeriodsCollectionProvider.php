...
use App\MonitoringConfiguration\Infrastructure\ApiPlatform\Resource\TimePeriod\TimePeriodCollectionOutput;
...
/**
 * @implements ProviderInterface<TimePeriodCollectionOutput>
 */
final readonly class ListTimePeriodsCollectionProvider implements ProviderInterface
{
    use FilterAwareProviderTrait;

    /**
     * @param TransformerInterface<TimePeriod, TimePeriodCollectionOutput> $transformer
     */
    public function __construct(
        #[Autowire(service: TimePeriodCollectionTransformer::class)]
    ...
    /**
     * @return iterable<TimePeriodCollectionOutput>
     */
