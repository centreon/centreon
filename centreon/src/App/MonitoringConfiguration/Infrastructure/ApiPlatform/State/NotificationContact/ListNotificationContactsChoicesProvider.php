...
use App\MonitoringConfiguration\Infrastructure\ApiPlatform\Resource\NotificationContact\NotificationContactChoicesOutput;
...
/**
 * @implements ProviderInterface<NotificationContactChoicesOutput>
 */
final readonly class ListNotificationContactsChoicesProvider implements ProviderInterface
{
    use FilterAwareProviderTrait;

    /**
     * @param TransformerInterface<NotificationContact, NotificationContactChoicesOutput> $transformer
     */
    public function __construct(
        #[Autowire(service: NotificationContactChoicesTransformer::class)]
    ...
    /**
     * @return iterable<NotificationContactChoicesOutput>
     */
