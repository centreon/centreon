...
use App\MonitoringConfiguration\Infrastructure\ApiPlatform\Resource\HostGroup\HostGroupChoicesOutput;
...
/**
 * @implements ProviderInterface<HostGroupChoicesOutput>
 */
final readonly class ListHostGroupsChoicesProvider implements ProviderInterface
{
    use FilterAwareProviderTrait;

    /**
     * @param TransformerInterface<HostGroup, HostGroupChoicesOutput> $transformer
     */
    public function __construct(
        #[Autowire(service: HostGroupChoicesTransformer::class)]
    ...
    /**
     * @return iterable<HostGroupChoicesOutput>
     */
