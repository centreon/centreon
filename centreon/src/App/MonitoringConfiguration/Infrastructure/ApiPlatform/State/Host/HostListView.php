...
/**
 * Host carries only PollerId/HostTemplateId; the Provider resolves their display
 * names once per page (see PollerNameResolver/HostTemplateNameResolver) and carries
 * the result here, since the aggregate itself has nowhere to hold them.
 */
final readonly class HostListView
{
    /**
