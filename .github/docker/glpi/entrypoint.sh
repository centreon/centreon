...
mysql -h${MYSQL_HOST} -uroot -p"${MYSQL_ROOT_PASSWORD}" glpi <<EOF
  ...
  UPDATE glpi_apiclients SET name = 'full access', ipv4_range_start = NULL, ipv4_range_end = NULL, ipv6 = NULL, app_token = 'Ns4CuByx9MBIZhkO83mMaKYrceFJ21YNmGDw59K8', app_token_date = '2024-10-14 12:33:47';
  UPDATE glpi_users SET api_token = 'R0MIlEL91Hhh2OJIGIS9y43TDFWCRX0r2aClU7sI', api_token_date = '2024-10-14 12:33:47' WHERE name = 'glpi';
EOF
