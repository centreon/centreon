...
class EasyvistaSoapProvider extends AbstractProvider
{
    ...
    protected $internal_arg_name = [
        self::ARG_ACCOUNT => ['formid' => 'Account', 'soapname' => 'Account'],
        self::ARG_CATALOG_GUID => ['formid' => 'CatalogGUID', 'soapname' => 'Catalog_GUID'],
        self::ARG_CATALOG_CODE => ['formid' => 'CatalogCode', 'soapname' => 'Catalog_Code'],
        self::ARG_ASSET_ID => ['formid' => 'AssetID', 'soapname' => 'AssetID'],
        self::ARG_ASSET_TAG => ['formid' => 'AssetTag', 'soapname' => 'AssetTag'],
        self::ARG_ASSET_NAME => ['formid' => 'AssetName', 'soapname' => 'ASSET_NAME'],
        self::ARG_URGENCY_ID => ['formid' => 'UrgencyId', 'soapname' => 'Urgency_ID'],
        self::ARG_SEVERITY_ID => ['formid' => 'SeverityId', 'soapname' => 'Severity_ID'],
        self::ARG_EXTERNAL_REFERENCE => ['formid' => 'ExternalReference', 'soapname' => 'External_reference'],
        self::ARG_PHONE => ['formid' => 'Phone', 'soapname' => 'Phone'],
        self::ARG_REQUESTOR_IDENTIFICATION => [
            'formid' => 'RequestorIdentification',
            'soapname' => 'Requestor_Identification'
        ],
        self::ARG_REQUESTOR_MAIL => ['formid' => 'RequestorMail', 'soapname' => 'Requestor_Mail'],
        self::ARG_REQUESTOR_NAME => ['formid' => 'RequestorName', 'soapname' => 'Requestor_Name'],
        self::ARG_LOCATION_ID => ['formid' => 'LocationID', 'soapname' => 'Location_ID'],
        self::ARG_LOCATION_CODE => ['formid' => 'LocationCode', 'soapname' => 'Location_Code'],
        self::ARG_DEPARTMENT_ID => ['formid' => 'DepartmentID', 'soapname' => 'Department_ID'],
        self::ARG_DEPARTMENT_CODE => ['formid' => 'DepartmentCode', 'soapname' => 'Department_Code'],
        self::ARG_RECIPIENT_ID => ['formid' => 'RecipientID', 'soapname' => 'Recipient_ID'],
        self::ARG_RECIPIENT_IDENTIFICATION => [
            'formid' => 'RecipientIdentification',
            'soapname' => 'Recipient_Identification'
        ],
        self::ARG_RECIPIENT_MAIL => ['formid' => 'RecipientMail', 'soapname' => 'Recipient_Mail'],
        self::ARG_RECIPIENT_NAME => ['formid' => 'RecipientName', 'soapname' => 'Recipient_Name'],
        self::ARG_ORIGIN => ['formid' => 'Origin', 'soapname' => 'Origin'],
        self::ARG_DESCRIPTION => ['formid' => 'Description', 'soapname' => 'Description'],
        self::ARG_PARENT_REQUEST => ['formid' => 'ParentRequest', 'soapname' => 'ParentRequest'],
        self::ARG_CI_ID => ['formid' => 'CiID', 'soapname' => 'CI_ID'],
        self::ARG_CI_ASSET_TAG => ['formid' => 'CiAssetTag', 'soapname' => 'CI_ASSET_TAG'],
        self::ARG_CI_NAME => ['formid' => 'CiName', 'soapname' => 'CI_NAME'],
        self::ARG_SUBMIT_DATE => ['formid' => 'SubmitDate', 'soapname' => 'SUBMIT_DATE']
    ];
    ...
    protected function setDefaultValueExtra()
    {
        ...
        $this->default_data['clones']['mappingTicket'] = [
            ['Arg' => self::ARG_ACCOUNT, 'Value' => 'Account name'],
            ['Arg' => self::ARG_DESCRIPTION, 'Value' => '{$body}'],
            ['Arg' => self::ARG_CATALOG_GUID, 'Value' => 'Catalog_GUID']
        ];
    }
...
';
        ...
        */
        ...
        if (preg_match('/^-[0-9]+/', $return_value)) {
            $map_error = [
                '-1' => 'invalid Account value',
                '-2' => 'Login/Password invalid',
                '-3' => 'invalid parameter',
