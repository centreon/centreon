...
class BmcFootprints11Provider extends AbstractProvider
{
    ...
    protected function setDefaultValueExtra()
    {
        ...
        $this->default_data['clones']['mappingTicket'] = [
            ...
            ['Arg' => self::ARG_STATUS, 'Value' => 'Open'],
            ['Arg' => self::ARG_PROJECTID, 'Value' => '1'],
            ['Arg' => self::ARG_ASSIGNEE, 'Value' => '{$user.alias}']
        ];
    }
    ...
    protected function getConfigContainer1Extra()
    {
        ...
        $array_form['mappingTicketProjectField'] = [
            [
                'label' => _("Name"),
                'html' => $mappingTicketProjectFieldName_html
            ],
            ['label' => _("Value"), 'html' => $mappingTicketProjectFieldValue_html]
        ];
    ...
    protected function createTicket($ticket_arguments, $ticket_project_fields)
    {
        ...
        foreach ($ticket_project_fields as $entry) {
            $type = 'string';
            if (preg_match('/^[0-9]+$/', (string) $entry['Value'])) {
                $type = 'integer';
            }
