...
class RequestTracker2Provider extends AbstractProvider
{
    ...
    protected function setDefaultValueExtra()
    {
        ...
        $this->default_data['clones']['mappingTicket'] = [
            ...
            ['Arg' => self::ARG_REQUESTOR, 'Value' => '{$user.email}'],
            ['Arg' => self::ARG_QUEUE, 'Value' => '{$select.rt_queue.value}']
        ];
    }
    ...
    protected function getConfigContainer1Extra()
    {
        ...
        $array_form = [
            ...
            'path' => ['label' => _("Path") . $this->required_field, 'html' => $path_html],
            'token' => ['label' => _("Token") . $this->required_field, 'html' => $token_html],
