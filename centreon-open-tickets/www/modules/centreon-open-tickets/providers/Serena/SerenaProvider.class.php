...
class SerenaProvider extends AbstractProvider
{
    ...
    protected function setDefaultValueExtra()
    {
        ...
        $this->default_data['clones']['mappingTicket'] = [
            ...
            ['Arg' => self::ARG_PROJECT_ID, 'Value' => '1']
        ];
    }
...
';
    ...
    protected function createTicketSerena($ticket_arguments)
    {
        $extended_fields = "";
        $listing = [
            $this->internal_arg_name[self::ARG_SUB_CATEGORY_DETAILS] => [
                'dbName' => 'OT_SUB_CATEGORY_DETAILS',
                'displayName' => 'Sub-category details'
            ],
            $this->internal_arg_name[self::ARG_SUB_CATEGORY] => [
                'dbName' => 'OT_SUB_CATEGORY',
                'displayName' => 'Sub-category'
            ],
            $this->internal_arg_name[self::ARG_CATEGORY] => ['dbName' => 'OT_CATEGORY', 'displayName' => 'OT_CATEGORY']
        ];
