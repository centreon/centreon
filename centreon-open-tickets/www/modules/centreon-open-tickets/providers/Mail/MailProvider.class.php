...
class MailProvider extends AbstractProvider
{
    ...
    protected function getConfigContainer1Extra()
    {
        ...
        $array_form = [
            'from' => ['label' => _("From") . $this->required_field, 'html' => $from_html],
            'to' => ['label' => _("To") . $this->required_field, 'html' => $to_html],
            'subject' => ['label' => _("Subject") . $this->required_field, 'html' => $subject_html],
            'header' => ['label' => _("Headers")],
            'ishtml' => ['label' => _("Use html"), 'html' => $ishtml_html]
        ];
        ...
        $headerMailValue_html = '<input id="headerMailValue_#index#" size="20" name="headerMailValue[#index#]" ' .
            'type="text" />';
        $array_form['headerMail'] = [
            ['label' => _("Name"), 'html' => $headerMailName_html],
            ['label' => _("Value"), 'html' => $headerMailValue_html]
        ];
