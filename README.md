...
Centreon is one of the most flexible and powerful monitoring software
...
The open source project is supported on a best-effort basis by the community,
and [commercial support](https://www.centreon.com/centreon-editions/) is
available for all supported versions.

Centreon releases one major version per year (typically end of October), with a
lifecycle of 18 months. Long-term support of 3 years is available under
commercial terms for versions released on even years (2024, 2026, etc.).

For more details, please refer to the [Product Lifecycle
Policy](https://docs.centreon.com/current/en/releases/lifecycle.html).

<h2> Contributing </h2>

Centreon was created by [Julien Mathis](https://github.com/julienmathis) and
[Romain Le Merlus](https://github.com/rlemerlus) and exists thanks to our
[**contributors**](https://github.com/centreon/centreon/graphs/contributors)!

Please read
[CONTRIBUTING.md](https://github.com/centreon/.github/blob/master/CONTRIBUTING.md)
for details on our code of conduct, bug report, feature request and the process
for submitting pull requests for us.
