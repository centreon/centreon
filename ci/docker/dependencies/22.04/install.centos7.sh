...
curl -o centreon-release.rpm "https://yum.centreon.com/standard/22.04/el7/stable/noarch/RPMS/centreon-release-22.04-3.el7.centos.noarch.rpm"
yum install --nogpgcheck centreon-release.rpm
curl -o centreon-release-business.rpm https://yum.centreon.com/centreon-business/1a97ff9985262bf3daf7a0919f9c59a6/22.04/el7/stable/noarch/RPMS/centreon-business-release-22.04-3.el7.centos.noarch.rpm
