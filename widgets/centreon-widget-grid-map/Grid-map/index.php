...
<html>
    ...
    <body>
   <?php
    if (/* isset($preferences['']) */ /* && */ $preferences['host_group'] != '' && $preferences['service'] != '') {
      print "<div id=\"Grid-map\"></div>";
    } else {
      print "<center><div class='update' style='text-align:center;width:350px;'>"._("Please select a host-group and services")."</div></center>";
    }
?>
    </body>
