...
$query .= "FROM {$ndoPrefix}hostgroups hg, {$ndoPrefix}objects o ";
$query .= "WHERE hg.hostgroup_object_id = o.object_id ";
$query .= "AND name1 != 'meta_hostgroup' ";
...
$hgMonObj->getHostStates($data, $detailMode, $centreon->user->admin, $aclObj, $preferences, true, $ndoPrefix);
$hgMonObj->getServiceStates($data, $detailMode, $centreon->user->admin, $aclObj, $preferences, true, $ndoPrefix);
