...
Centreon AWIE s'appuie sur les commandes CLAPI mais possède l'avantage de pouvoir les exécuter depuis l'interface graphique au lieu d'avoir à les taper dans un terminal.
