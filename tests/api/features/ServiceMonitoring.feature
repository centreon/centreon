Feature:
    ...
    Scenario: Service listing and details
        ...
        When I send a GET request to '/v21.10/monitoring/services?search={"host.name":"test"}'
        Then the response code should be "200"
        And the JSON node "result" should have "2" elements

        When I send a GET request to '/v21.10/monitoring/services?search={"$and":[{"host.name":"test"},{"service.description":"test_service1"}]}'
        Then the response code should be "200"
