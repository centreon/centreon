Feature:
  ...
  Scenario: User filters
    ...
    When I send a GET request to '/v21.10/users/filters/events-view'
    Then the response code should be "200"
    And the json node "result" should have 0 elements

    When I send a POST request to '/v21.10/users/filters/events-view' with body:
    """
    {
      "name": "my filter1",
      "criterias": [
    ...
    When I send a GET request to '/v21.10/users/filters/events-view/1'
    Then the response code should be "200"
    And the json node "name" should be equal to the string "my filter1"
    And the json node "order" should be equal to the number 1

    When I send a PUT request to '/v21.10/users/filters/events-view/1' with body:
    """
    {
      "name": "filter1",
      "criterias": [
    ...
    When I send a PATCH request to '/v21.10/users/filters/events-view/1' with body:
    """
    {
      "order": 2
    }
    ...
    When I send a GET request to '/v21.10/users/filters/events-view/2'
    Then the response code should be "200"
    And the json node "order" should be equal to the number 1

    When I send a DELETE request to '/v21.10/users/filters/events-view/1'
  ...
  Scenario: Updated criterias
    ...
    And I send a GET request to '/v21.10/users/filters/events-view/1'
