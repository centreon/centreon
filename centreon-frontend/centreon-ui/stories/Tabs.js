...
storiesOf("Tabs", module).add("Tabs - custom", () => <Tabs>
...
</Tabs>, {notes: "A very simple component"});

storiesOf("Tabs", module).add("Tabs - custom with errors", () => <Tabs error="The form has errors">
  <Tab label="Configuration">
    Lorem Ipsum dolor sit amet Configuration
  </Tab>
