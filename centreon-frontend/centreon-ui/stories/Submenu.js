...
storiesOf("Submenu", module).add("Submenu - toggled with top and bottom items", () => (
  <SubmenuHeader submenuType="header">
    <div className="submenu-top submenu-active" style={{
      width: "200px"
    }}>
      ...
      <div className="submenu-toggle">
        <SubmenuItems>
          ...
          <SubmenuItem
            ...
            submenuTitle="Down"
            submenuCount="0/0"/>
          <SubmenuItem dotColored="gray" submenuTitle="Unreachable" submenuCount="0/0"/>
          <SubmenuItem dotColored="green" submenuTitle="Up" submenuCount="151"/>
          <SubmenuItem dotColored="blue" submenuTitle="Pending" submenuCount="0"/>
        </SubmenuItems>
      </div>
    </div>
  </SubmenuHeader>
