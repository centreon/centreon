...
function (_Component) {
  ...
  function InputFieldMultiSelect() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(InputFieldMultiSelect).apply(this, arguments));
  }
  ...
  _createClass(InputFieldMultiSelect, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        className: "multi-select ".concat(size ? size : '', " ").concat(active ? active : '') + (error ? ' has-danger' : '')
        ...
        iconType: "arrow"
      })), _react.default.createElement(_ScrollBar.default, null, _react.default.createElement("div", {
