...
var CentreonDynamicComponentGetter = function (_Component) {
  ...
  function CentreonDynamicComponentGetter() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CentreonDynamicComponentGetter.__proto__ || Object.getPrototypeOf(CentreonDynamicComponentGetter)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      topologyUrl: "",
      componentName: false
...
exports.default = CentreonDynamicComponentGetter;