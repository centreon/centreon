...
var DynamicComponent = function (_Component) {
  ...
  function DynamicComponent() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DynamicComponent.__proto__ || Object.getPrototypeOf(DynamicComponent)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
  ...
  _createClass(DynamicComponent, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          componentUrl = _props.componentUrl,
          componentName = _props.componentName;


      var Comp = componentName ? window[componentName] : _react2.default.createElement('div', null);

      return _react2.default.createElement(
        _react2.default.Fragment,
        null,
        componentLoaded ? _react2.default.createElement(Comp, null) : _react2.default.createElement('iframe', {
          src: componentUrl,
